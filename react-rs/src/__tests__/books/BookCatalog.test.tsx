...
const mockBooksData = [
  ...
  },
  {
    author: 'Boris Cherny',
    imageLink:
      'https://www.swiatksiazki.pl/media/catalog/product/cache/eaf55611dc9c3a2fa4224fad2468d647/3/2/3299906536732.jpg',
  ...
  },
  {
    ...
    imageLink:
      'https://images.manning.com/264/352/resize/book/5/62a5fdd-76fc-4d24-a3f7-83633cf2631d/cantelon.png',
  ...
  {
    author: 'Kyle Simpson',
    imageLink: 'https://m.media-amazon.com/images/I/41T5H8u7fUL._AC_SY1000_.jpg',
  ...
  },
  {
    ...
    imageLink: 'https://m.media-amazon.com/images/I/51Uo38cMKKL._AC_SY1000_.jpg',
...
test('BookCatalog component should render a list of book items', async () => {
  jest.spyOn(global, 'fetch').mockResolvedValue({
    json: jest.fn().mockResolvedValue(mockBooksData),
  } as unknown as Response);

  const { container } = render(<BookCatalog />);

  await waitFor(() => {
    expect(container.getElementsByClassName('book-item').length).toBe(mockBooksData.length);
  });
});
